...
export default function ChatInterface() {
  ...
  if (!problem || !solution) {
    return (
      <div className="glass rounded-xl p-6 text-center border card-shadow">
  ...
  return (
    <div className="glass rounded-xl border flex flex-col h-96 card-shadow">
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        <h3 className="text-lg font-semibold">Algorithm Q&A</h3>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="glass border px-4 py-2 rounded-lg">
              <div className="flex items-center space-x-2">
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-white/10">
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="px-4 py-2 bg-primary text-white rounded-md hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:opacity-50 disabled:cursor-not-allowed border border-white/10"
          >
            {isLoading ? (
